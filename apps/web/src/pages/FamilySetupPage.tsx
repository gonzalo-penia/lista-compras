...
export function FamilySetupPage() {
  ...
  if (mode === 'pick') {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-emerald-100">
        <div className="bg-white rounded-2xl shadow-xl p-10 w-full max-w-sm text-center space-y-4">
          <h1 className="text-2xl font-bold text-primary-700">FamilyCart</h1>
          <p className="text-gray-500 text-sm">Empezá creando tu familia o uniéndote a una existente</p>
          <button
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-emerald-100">
      <div className="bg-white rounded-2xl shadow-xl p-10 w-full max-w-sm space-y-4">
        <button
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <input
            ...
            className="w-full border border-gray-300 rounded-xl px-4 py-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-primary-500"
            autoFocus
          />
